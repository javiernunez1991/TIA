...
# replay.add(random_exper(DEVICE), 0, 111, True, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 5, 222, False, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 4, 333, True, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 2, 444, True, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 1, 555, False, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 0, 666, True, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 3, 777, False, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 3, 888, False, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 4, 999, True, random_exper(DEVICE))
# replay.add(random_exper(DEVICE), 2, 101010, False, random_exper(DEVICE))# mini_batch = replay.sample(batch_size)
