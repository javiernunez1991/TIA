...
class DQNAgent(Agent):
    ...
    def update_weights(self):
        if len(self.memory) > self.batch_size:
            ...
            state_q_values = q_values.gather(1, actions.unsqueeze(1))
            ...
            q_next_states = torch.max(next_q_values, dim=1)
            ...
            # Compute el costo y actualice los pesos. En Pytorch la funcion de costo se llaman con (predicciones, objetivos) en ese orden.
